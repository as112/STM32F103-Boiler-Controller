...
// Размеры индикатора
#define HD44780_ROWS                    2       //2       // Кол-во строк
#define HD44780_COLS                    16      //16      // Кол-во столбцов
...
#define HD44780_pcf8574_mode            1       //1       // Работа с дисплеем через i2c-адаптер на pcf8574 (иначе - напрямую)      
  ...
  // 0x20-0x27 для pcf8574 и 0x38-0x3F для pcf8574a.
  ...
  #define HD44780_4bitMode              1       // НЕ МЕНЯТЬ - 4-бит режим  
...
#define HD44780_ShortDelayUs            1       // Короткая задержка (между фронтами E)   
